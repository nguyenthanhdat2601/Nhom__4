...
sopt = IntVar()
Label(win, text='Nhập số phương trình', font=('Arial', 13), bg='yellow', fg='black', height=1, relief='solid', borderwidth=2, width=30).place(x=250, y=60)
entry = Entry(win, textvariable=sopt, font=('Arial', 13), bg='yellow', fg='black', relief='solid', borderwidth=2, width=5)
...
Button(win, text='Create', command=create, font=('Times new roman', 15), fg='black', bg='brown', width=6, height=2, relief='solid', borderwidth=2).place(x=250, y=510)
...
Button(win, text='Clear', command=clear, font=('Times new roman', 15), fg='black', bg='brown', width=6, height=2, relief='solid', borderwidth=2).place(x=445, y=510)
Button(win, text='Calculate', command=calculate, font=('Times new roman', 15), fg='black', bg='brown', width=7, height=2, relief='solid', borderwidth=2).place(x=537, y=510)
